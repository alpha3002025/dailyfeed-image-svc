...
project(":dailyfeed-image") {
    // Spring Boot main class 설정
    tasks.withType<org.springframework.boot.gradle.tasks.bundling.BootJar> {
        mainClass.set("click.dailyfeed.image.ImageApplication")
    }
    ...
    jib {
        ...
        to {
            ...
            image = "ghcr.io/alpha3002025/dailyfeed-image-svc"
        ...
        container {
            // Main class 명시
            mainClass = "click.dailyfeed.image.ImageApplication"
            // JVM 옵션
            jvmFlags = listOf(
